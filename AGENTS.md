...
⛔ OGNI regola, istruzione, convenzione o linea guida creata o modificata in questo progetto **deve essere compatibile sia con Codex che con GitHub Copilot**.
...
- Indica modello LLM usato (es. `Codex-sonnet-4-6`)
