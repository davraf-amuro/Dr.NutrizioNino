...
const props = defineProps<{ recipes: FoodDashboardDto[] }>()
const emit = defineEmits<{
  delete: [recipe: FoodDashboardDto]
  detail: [recipe: FoodDashboardDto]
}>()

const { searchQuery, filteredData } = useTableSearch(() => props.recipes, 'name')
